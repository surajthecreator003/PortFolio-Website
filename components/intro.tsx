"use client"// beacuse of motion.div using useEffect in background
...
export default function Intro() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
        ...
        <div className="flex items-center justify-center">
          <div className="relative">
           <motion.div initial={{opacity:0,scale:0}} animate={{opacity:1,scale:1}} transition={{type:"tween",duration:0.2}}>
            ...
            <motion.span className="text-4xl absolute  bottom-0 right-0" initial={{opacity:0,scale:1}} animate={{opacity:1,scale:1}} transition={{type:`spring`,stiffness:125,delay:0.1,duration:0.7}}>
                👋
            </motion.span>
         </div>
        </div>
      ...
      >
        <span className="font-bold">Hello, I'm Suraj.</span> I'm a passioante and versatile{" "}
      ...
      <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4
                       text-lg font-medium" initial={{ opacity: 0, y:100 }}
                       animate={{ opacity: 1, y:0 }}
                       transition={{
        ...
        <a
          ...
          href="https://www.linkedin.com/in/suraj-mallick-8a636816a/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/surajthecreator003"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
...
//appostopies can cause error so better use templeate lietral ''
//because of jSX oir use &pos for apostopies
