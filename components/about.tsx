...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        Am a{" "}
        <span className="font-medium">Computer Science</span> student, I enrolled in a coding bootcamp and learned{" "}
        ...
        <span className="font-medium">
          React, Next.js, Node.js,MongoDB,Express.js,AWS,Git,GitHub,Docker,Java
        </span>
